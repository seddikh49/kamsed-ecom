...
const Hero = () => {
  return (
    <div className='flex  xl:h-[500px] xl:flex-row lg:flex-col xm:flex-col sm:flex-col w-full justify-center items-center  border border-gray-400 '>
       <div className='xl:w-1/2 lg:w-full sm:w-full xm:w-full h-full'>
        ...
        <div className='xl:w-1/2  py-10 flex  xm:w-full sm:w-full  lg:1/2 justify-center  items-center'>
          ...
          <h1 className='xl:text-4xl lg:text-4xl md:text-5xl inline sm:text-4xl xm:text-2xl  text-gray-600 font-bold whitespace-nowrap '> توصيل سريع خلال 3 أيام </h1>
